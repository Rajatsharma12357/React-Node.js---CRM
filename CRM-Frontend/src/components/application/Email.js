                    ...
                    <div className="content">
                        ...
                        <div className="row">
                            <div className="col-lg-3 col-md-12">
                                <div className="compose-bLinkn">
                                    <Link to="/" className="btn btn-primary btn-block w-100">
                                        Compose
                                    </Link>
                                </div>
                                <ul className="inbox-menu">
                                    <li className="actiLinke">
                                        <Link to="/"><i className="fas fa-download"></i> Inbox <span
                                            className="mail-count">(5)</span></Link>
                                    </li>
                                Link<li>
                                        <Link to="/"><i className="far fa-star"></i> Important</Link>
                                    </li>
                                Link<li>
                                        <Link to="/"><i className="far fa-paper-plane"></i> Sent Mail</Link>
                                    </li>
                                Link<li>
                                        <Link to="/"><i className="far fa-file-alt"></i> Drafts <span
                                            className="mail-count">(13)</span></Link>
                                    </li>
                                Link<li>
                                        <Link to="/"><i className="far fa-trash-alt"></i> Trash</Link>
                                    </li>
                                </ul>
                            </div>
                                                    ...
                                                    <div className="float-left">
                                                        <div className="btn-group dropdown-action me-1">
                                                            ...
                                                            <div className="dropdown-menu">
                                                                ...
                                                                <Link className="dropdown-item" to="/">None</Link>
                                                                <div className="dropdown-divider"></div>
                                                                <Link className="dropdown-item" to="/">Read</Link>
                                                                <Link className="dropdown-item" to="/">Unread</Link>
                                                            </div>
                                                        </div>
                                                        <div className="btn-group dropdown-action me-1">
                                                            <button type="button" className="btn btn-white dropdown-toggle"
                                                        ...
                                                        <div className="btn-group dropdown-action me-1">
                                                            <button type="button" className="btn btn-white dropdown-toggle"
                                                                data-bs-toggle="dropdown"><i className="fas fa-folder"></i> <i
                                                                    className="fas fa-angle-down"></i></button>
                                                            <div role="menu" className="dropdown-menu">
                                                                ...
                                                                <Link className="dropdown-item" to="/">Trash</Link>
                                                                <div className="dropdown-divider"></div>
                                                                <Link className="dropdown-item" to="/">New</Link>
                                                            </div>
                                                        </div>
                                                        <div className="btn-group dropdown-action me-1">
                                                            <button type="button" data-bs-toggle="dropdown"
                                                                className="btn btn-white dropdown-toggle"><i
                                                                    className="fas fa-tags"></i> <i
                                                                        className="fas fa-angle-down"></i></button>
                                                            <div role="menu" className="dropdown-menu">
                                                                <Link className="dropdown-item" to="/">Work</Link>
                                                                <Link className="dropdown-item" to="/">Family</Link>
                                                                <Link className="dropdown-item" to="/">Social</Link>
                                                                <div className="dropdown-divider"></div>
                                                                <Link className="dropdown-item" to="/">Primary</Link>
                                                ...
                                                <div className="col-lg-3 top-action-right col-sm-12">
                                                    <div className="text-end ">
                                                        <button type="button" title="Refresh" data-toggle="tooltip"
                                                            className="btn btn-white d-none d-md-inline-block me-1"><i
                                                    ...
                                                    <div className="text-end">
                                                        <span className="text-muted d-none d-md-inline-block">Showing 10 of 112
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <table className="table table-inbox table-hover">
                                                    ...
                                                    <tbody>
                                                        <tr className="unread clickable-row">
                                                            ...
                                                            <td><span className="mail-important"><i
                                                                className="fas fa-star starred"></i></span></td>
                                                            <td className="name">John Doe</td>
                                                            <td className="subject">Lorem ipsum dolor sit amet, consectetuer
                                                                adipiscing elit</td>
                                                        ...
                                                        <tr className="unread clickable-row">
                                                            ...
                                                            <td><span className="mail-important"><i className="far fa-star"></i></span>
                                                            </td>
                                                            <td className="name">Envato Account</td>
                                                            <td className="subject">Important account security update from Envato
                                                            </td>
                                                            <td></td>
                                                        ...
                                                        <tr className="clickable-row">
                                                            ...
                                                            <td><span className="mail-important"><i
                                                                className="far fa-star starred"></i></span></td>
