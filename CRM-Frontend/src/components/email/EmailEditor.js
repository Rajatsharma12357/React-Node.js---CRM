...
import { getPhotoFiles, uploadPhotoFiles, getImageDimensions } from "../../lib/index";
    ...
    <>
      {state ? (<>
        <div className="export_button">
          <button className="btn btn-primary" onClick={() => exportHtml()}>Save Design</button>
        </div>
